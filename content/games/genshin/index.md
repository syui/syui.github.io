...
|2023|04|44,000|-22,000|22,000|フリーナ(2凸)|
...
サイトで確認するとこの聖遺物は上位1%の世界ランク1539位に当たります。1位と比較すると、`会心率+10%`, `会心ダメ+15%`が足りません。

|rank|会心率|会心ダメ|熟知|user|
|---|---|---|---|---|
|#1|72.7|168.9|714||
|#1539|64.9|141.7|732|syui|
...
原神における最強キャラとは、アタッカーではなく、サポートもできるキャラとなります。また、クールタイムを考慮しましょう。
...
理由として、風元素には拡散反応、拡散ダメージがあるからです。複数の原素反応に影響を及ぼす元素が風と草になります。
