...
あらかじめダウンロードしたアセットデータは無駄になりますので、updateが来たときに(1)原神を削除、(2)原神をインストール、(3)起動時にアセットをダウンロードの手順を取る必要があります。

原神が入らなくなったときがipadの買い替えどきだと思っています。
...
具体的には、配布武器、元素チャージ効率、祭礼や西風効果など採用するのが良さそうに思います。
