...
<video controls preload="metadata" style="width:100%;" poster="/img/aiue.png"><source src="https://git.syui.ai/syui/video/raw/branch/main/aiue.mp4"></video>

一応は、動作するところまでやりましたが、それ以降はあまりやる気が出ず放置しています。

色々と書いてきましたが、私はかなり気分屋なところがあって、blueskyをやっていなかったら、こういうことをやっていたかは怪しいです。

例えば、pdsをself-hostしたり、ゲームを作ったり。
...
<div class="vrm-model">
<iframe src="https://vrm.syui.ai" allowfullscreen frameborder="0" width="100%" height="450px" scrolling="no"></iframe>
</div>
