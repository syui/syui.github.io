...
|氷|氷神|スカーク(<font color="#1E90FF">c5</font>)|
...
当初からmihoyoの好みはマーヴィカと氷神に集約されると予想していて、どちらも完凸する予定でした。基本的には白髮と黒髪、炎と氷キャラは強くなる傾向にあると思います。

その後の情報でスカークがナタで実装されそうなので、マーヴィカの完凸を中止し、スカークを完凸する方向で考えています。
...
ただし、仮にスカークが氷元素だった場合、氷神まで完凸すると、同じ属性で完凸が2人になってしまいます。完凸キャラの属性は重複しないようにしたいと考えています。その場合は、氷神の完凸予定は修正するかもしれません。
