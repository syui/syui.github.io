...
すべてue5だけで完結することだけが魅力ですが、拡張性がありませんし、リスクが大きいのです。
...
`8080`がweb, `1935`がrtmp, `6000`がsrtです。rtmpとsrtではstrのほうが高品質で遅延が少なくなると思います。使わないものはportを閉じてもokです。基本的にはバッティングなどもありますから以下のようにlocahostのportを変えて使うのがいいですね。
