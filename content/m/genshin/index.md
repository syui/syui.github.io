...
また、当初からmihoyoの好みは炎神と氷神に集約されると予想していて、どちらも完凸する予定です。
...
後悔したことはありませんが、あえて挙げるなら`甘雨`を全く使わなかったので確保しなくてよかった点です。綾華だけは今使わなくなってしまいましたが、当時はずっと先陣で使っていました。

私の先陣は`クレー` -> `綾華` -> `ヌヴィレット`の順に入れ替わっています。そのため、クレーと綾華だけは今現在使わなくなっています。とはいえ、クレーはお気に入りキャラなので確保しておいてよかった。それに稲妻までずっとお世話になったキャラでもあり、最も思い出に残っているキャラでもあります。綾華は移動要因として重宝しています。

しかし、今現在の環境では`クレー`, `綾華`, `甘雨`はおすすめしません。

反対に満足していることはナヒーダを完凸したことです。完凸してから色々な高難易度のイベントとかもありました。螺旋も難易度が上がったこともありました。それらを切り抜けられたのは間違いなくナヒーダ完凸のおかげでした。

ナヒーダは私の持ちキャラの中では最強キャラで、フリーナやヌヴィレット(一応凸あり)を使ったうえでも個人的所感では最強でした。ヌヴィレットでやって駄目だったコンテンツでもナヒーダでやるとクリアできたりタイムが縮まったり、そういった体験が何度も積み重なり、「うーむ、ナヒーダがやっぱり一番強いと思う」という結論になりました。まあ、完凸あっての評価かもしれませんけど。

それでもナヒーダはいくつかの個体要素が強すぎるのです。まずは攻撃の必中化と全体化スキルです。今後も腐ることはないと思います。フリーナも非常に良いスキルを持っていて、あれも便利ですけどね。どのような環境でも腐ることはないでしょう。あとは草元素であること、2凸の防御ダウンです。PT単位での評価になりますが、原神では私が評価するキャラはPT全体で活躍できるキャラです。

今現在、雷電は評価を落としていますが、私は雷電を確保推奨しています。というのも、螺旋とか幻想をやっていると思うのが「雷電がいるとクリアできる」です。これが鍾離や万葉だった場合、クリアできないことがあります。螺旋はナヒーダと雷電がいればあとは星4キャラを組み合わせてPTができるので、確保しているキャラが少ない人には最もおすすめです。
